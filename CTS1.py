...
import subprocess, os, string ,ttk ,time ,ConfigParser
#import requests
import json
...
class MyFirstGUI:
	...
	#    self.modelLabel.configure(text='''Model''')
		...
		self.gpsButton.configure(text='''GPS''')

		self.gpsButton =Button (master, command=self.adbchange)
		self.gpsButton.place(x=350, y=330, height=28, width=52)
		self.gpsButton.configure(text='''adb39''')
	...
	#	print("sadasd"+ Wificomboxlist)
		...
		#	sample =(" python /CTS_tool/for_pythonUI/test/DeviceSetup.py ")+"serial:"+str(serialString)+" SSID:CTS_GSI"+" PSK:01111111"
			sample =(" python /CTS_tool/for_pythonUI/DeviceSetup.py ")+"serial:"+str(serialString)+" SSID:"+str(Wificomboxlist) +" 12>>log.txt"
	...
	def adbchange(self):
		...
		pcname = subprocess.check_output(str('whoami').split())
	#	print(pcname)
		subprocess.check_output(str("cp /CTS_tool/for_pythonUI/adb39 /home/"+pcname+"/android-sdk-linux/platform-tools/adb").split())
#    		subprocess.Popen(sample, shell=True)
 #   	print sample
		#self.sample_code()
		#print "44444"
	...
	def VTS(self):
		...
		if sdk == "27": #8.1
			...
			itemsforlistbox=['VTS-11_r1','VTS-11_r2']
		elif sdk == "29": #10.0
